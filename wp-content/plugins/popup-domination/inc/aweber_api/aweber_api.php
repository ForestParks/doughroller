<?php
$url = rtrim(POPUP_DOM_PATH,'/');
if(isset($_GET['path'])){
	$url = $_GET['path'];
}
require_once($url.'/inc/aweber_api/exceptions.php');
require_once($url.'/inc/aweber_api/oauth_adapter.php');
require_once($url.'/inc/aweber_api/oauth_application.php');
require_once($url.'/inc/aweber_api/aweber_response.php');
require_once($url.'/inc/aweber_api/aweber_collection.php');
require_once($url.'/inc/aweber_api/aweber_entry_data_array.php');
require_once($url.'/inc/aweber_api/aweber_entry.php');
