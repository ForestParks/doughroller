...
// actions
add_action( 'manage_posts_custom_column', 'ta_review_post_data_row', 10, 2);			// manage post review rating column
add_action('manage_page_posts_custom_column', 'ta_review_post_data_row', 10, 2); 		// manage page review rating column

// filters
add_filter( 'manage_edit-post_columns', 'ta_review_post_header_columns', 10, 1);		// add title in post manage 
add_filter('manage_page_posts_columns', 'ta_review_post_header_columns', 10);			// add title in page manage
