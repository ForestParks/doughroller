...
class WP_Widget_Recent_Reviews extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array('classname' => 'widget_recent_reviews', 'description' => __( "Display post reviews on your site") );
		parent::__construct('recent-reviews', __('Reviews'), $widget_ops);
...
?>
        ...
        <li>
        	<a href="<?php the_permalink() ?>" title="<?php echo esc_attr(get_the_title() ? get_the_title() : get_the_ID()); ?>"><?php if ( $rating_name ) echo $rating_name; else the_ID(); ?></a>
            
			<?php
            echo '<div class="ta_rating result rating ta_widget_rating">';
			echo '<div class="result" style="width:' . $rating_star . '%;" title="' . $rating . '"></div>';
