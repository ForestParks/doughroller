	...
	function foundationpress_entry_meta() { ?>
        ...
        <div class="entry_meta_social floating">
                ...
                <div class="linkedin ems">
                 ...
                 <div class="email ems">
                        <a href="mailto:?subject=I wanted you to see this post&amp;body=Check out the post here <?php echo urlencode(get_permalink($post->ID)); ?>"" title="Share by Email"><i class="fa fa-envelope" aria-hidden="true"></i></a>
                </div>
